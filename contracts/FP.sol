...
contract ERC721 is ERC165, IERC721 {
    ...
    ***********************************************/
     ...
     */
    function transferFrom(address from, address to, uint256 tokenId) public onlyNotFrozen(tokenId) onlySecured(tokenId) {
     ...
     * @param tokenId uint256 ID of the token to be transferred
     */
    function safeTransferFrom(address from, address to, uint256 tokenId) public onlyNotFrozen(tokenId) onlySecured(tokenId) {
     ...
     */
    function safeTransferFrom(address from, address to, uint256 tokenId, bytes memory _data) public onlyNotFrozen(tokenId) onlySecured(tokenId) {
